...
namespace YaR.WebDavMailRu.CloudStore.Mailru.StoreBase
{
    public sealed class MailruStore : IStore
    {
        ...
        private string GetPathFromUri(Uri uri)
        {
			...
			requestedPath = requestedPath.Replace("desktop.ini", string.Empty);
			requestedPath = requestedPath.Replace("HEAD", string.Empty);
			requestedPath = requestedPath.Replace(".git", string.Empty);
